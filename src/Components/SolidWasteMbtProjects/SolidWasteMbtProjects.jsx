...
import mbt from "./../../assets/imgs/services/mbt.jpg";

export default function SolidWasteMbtProjects() {
        ...
        <div className="service-content py-5">
          <div className="container">
            ...
            <div className="overflow-x-auto">
              <table className="w-100 my-5 projectsTable text">
                <tbody>
                  <tr>
                    <th className="mainBg w-20 p-3  fs-5 fw-bold text-nowrap">
                      {t("projectName")}
                    </th>
                    <th className="mainBg p-3  fs-5 fw-bold text-nowrap">
                      {t("keyProjectDetails")}
                    </th>
                    <th className="mainBg w-20 p-3  fs-5 fw-bold text-nowrap">
                      <i className="fa-solid fa-location-dot"></i>{" "}
