...
import project29pic1 from "./../../../../assets/imgs/projects/Waste Characterization Study in Fayoum and Minya/Picture31.jpg";
import project29Bg from "./../../../../assets/imgs/projects/Waste Characterization Study in Fayoum and Minya/Picture32.jpg";
      ...
      <div className="projectDetailsPage">
        <div className="service-landing position-relative overflow-hidden">
          <img
            ...
            src={project29Bg}
            alt="Waste Characterization Study in Fayoum and Minya, Egypt"
          />
          <div
            className={
              language === "en"
            ...
            <span>
              {" "}
              {language === "en" ? (
                <Link className="text-white" to="/ConsultancyServicesProjects">
                  {" "}
        ...
        <div className="service-content py-5">
          <div className="container">
            <div className="text-center mb-5">
              <h4 className="fw-bold">{t("wasteStudyInFayoumAndMinya")}</h4>
              <p className="fw-medium">{t("secondWasteSInFandM")}</p>
            </div>
            <div className="row mb-5">
              ...
              <div className="col-lg-7">
                <div>
                  <p>{t("wasteStudyInFayoumAndMinyaDesc")}</p>
                  <p>{t("wasteStudyInFayoumAndMinyaDesc2")}</p>
                </div>
              </div>
            </div>
