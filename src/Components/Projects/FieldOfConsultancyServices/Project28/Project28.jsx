...
import project28pic1 from "./../../../../assets/imgs/projects/Waste Characterization Study in Qalubia/Picture30.png";

import project28Bg from "./../../../../assets/imgs/projects/Waste Characterization Study in Qalubia/Picture29.png";
        ...
        <div className="service-content py-5">
          <div className="container">
            <div className="text-center mb-5">
              <h4 className="fw-bold">{t("wasteStudyInQalubia")}</h4>
              <p className="fw-medium">{t("Qalubia")}</p>
            </div>
            <div className="row mb-5">
              ...
              <div className="col-lg-7">
                <div>
                  <p>{t("wasteStudyInQalubiaDesc")}</p>
                  <p>{t("wasteStudyInQalubiaDesc2")}</p>
                </div>
              </div>
            </div>
