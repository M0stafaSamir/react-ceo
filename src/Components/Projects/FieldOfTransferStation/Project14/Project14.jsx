...
import projectt14tnBg from "./../../../../assets/imgs/projects/Talla transfer station/Picture20.jpg";
import project14pic1 from "./../../../../assets/imgs/projects/Talla transfer station/Picture21.jpg";
        ...
        <div className="service-content py-5">
          <div className="container">
            <div className="text-center mb-5">
              <h4 className="fw-bold">{t("TallaTS")}</h4>
              <p className="fw-medium">{t("Talla")}</p>
            </div>
