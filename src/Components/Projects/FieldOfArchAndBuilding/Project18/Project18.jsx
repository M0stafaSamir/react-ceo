...
import project18Bg from "./../../../../assets/imgs/projects/Academic Institute of Medicine/facultyofmedicin.jpg";
import project18Pic1 from "./../../../../assets/imgs/projects/Academic Institute of Medicine/Picture6.jpg";
import mokaulounpic from "./../../../../assets/imgs/projects/Academic Institute of Medicine/elmokawlon.png";
      ...
      <div className="projectDetailsPage">
        <div className="service-landing position-relative overflow-hidden">
          <img
            ...
            src={project18Bg}
            alt="Academic Institute of Medicine, Ain Shams"
          />
          <div
            className={
              language === "en"
        ...
        <div className="service-content py-5">
          <div className="container">
            <div className="text-center mb-5">
              <h4 className="fw-bold">{t("academicInstitute")}</h4>
              <p className="fw-medium">{t("ainShams")}</p>
            </div>
