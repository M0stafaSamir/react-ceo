...
import serviceFivePic from "./../../assets/imgs/services/highway.webp";
import bridge from "./../../assets/imgs/services/bridge.png";
      ...
      <div className="servicePage">
        <div className="service-landing position-relative overflow-hidden w-100">
          ...
          <div
            ...
            <span className="mainColor"> {t("service5")}</span>
          </div>
        </div>
