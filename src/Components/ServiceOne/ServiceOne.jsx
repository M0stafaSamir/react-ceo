...
import serviceOnePic from "./../../assets/imgs/services/arch.jpg";
import buldingPic from "./../../assets/imgs/services/building.webp";
      ...
      <div className="servicePage">
        <div className="service-landing position-relative overflow-hidden w-100">
          <img
            ...
            src={serviceOnePic}
            alt="Architecture and Building Engineering"
          />
          <div
            className={
              language === "en"
            ...
            <span className="mainColor"> {t("service1")}</span>
          </div>
        </div>
